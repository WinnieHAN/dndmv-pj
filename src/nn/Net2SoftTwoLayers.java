...
public class Net2SoftTwoLayers {
	public SimpleMatrix weight1Para;
	public SimpleMatrix weight2Para;
	public SimpleMatrix bias1Para;
	public SimpleMatrix bias2Para;
	...
	private ArrayList<SimpleMatrix> gradOfFunctionOfBias1;
	private ArrayList<SimpleMatrix> gradOfFunctionOfBias2;
...
//	}
	...
	public Net2SoftTwoLayers(Node parNode, Node childNode, SimpleMatrix initWeight1, SimpleMatrix initWeight2, SimpleMatrix initBias1, SimpleMatrix initBias2, SimpleMatrix valencyv, SimpleMatrix dirVec,
		...
		this.bias1Para = initBias1;
		this.bias2Para = initBias2;
		...
		hidVec1 = (this.weight1Para.mult(this.inputVec)).plus(this.bias1Para);
		...
		hidVec2 = (this.weight2Para.mult(this.hidVec1)).plus(this.bias2Para);
...
//				if(sc > 100)
	...
	public SimpleMatrix gradientOfBias1(Word w, HashMap<String, Integer> dic) throws Exception{//dic is not used
		SimpleMatrix g = null;
		//int index = dic.get(w.wordName);
		int index = 0;
		for(int i = 0; i < this.dicSize; i++){
		...
		for(int i = 0; i < this.dicSize; i++){
			if(i == 0){
				double sc = Math.exp(this.scoresInDic.get(i));
				g = (this.gradOfFunctionOfBias1.get(index).minus(this.gradOfFunctionOfBias1.get(i))).scale(sc); 
			}
			else{
				double sc = Math.exp(this.scoresInDic.get(i));
				SimpleMatrix tmp = (this.gradOfFunctionOfBias1.get(index).minus(this.gradOfFunctionOfBias1.get(i))).scale(sc); 
				g = g.plus(tmp);
			}
		}
	...
	public SimpleMatrix gradientOfBias2(Word w, HashMap<String, Integer> dic) throws Exception{//dic is not used
		SimpleMatrix g = null;
		//int index = dic.get(w.wordName);
		int index = 0;
		for(int i = 0; i < this.dicSize; i++){
		...
		for(int i = 0; i < this.dicSize; i++){
			if(i == 0){
				double sc = Math.exp(this.scoresInDic.get(i));
				g = (this.gradOfFunctionOfBias2.get(index).minus(this.gradOfFunctionOfBias2.get(i))).scale(sc); 
			}
			else{
				double sc = Math.exp(this.scoresInDic.get(i));
				SimpleMatrix tmp = (this.gradOfFunctionOfBias2.get(index).minus(this.gradOfFunctionOfBias2.get(i))).scale(sc); 
				g = g.plus(tmp);
			}
		}
	...
	public SimpleMatrix backwardOfBias1(HashMap<String, Integer> dic) throws Exception{
		return gradientOfBias1(this.childNode.word, dic);

	}

	public SimpleMatrix backwardOfBias2(HashMap<String, Integer> dic) throws Exception{
		return gradientOfBias2(this.childNode.word, dic);
	...
	public void calGrads(){
		...
		gradOfFunctionOfBias1 = new ArrayList<>();
		gradOfFunctionOfBias2 = new ArrayList<>();		
		...
		for(int i = 0; i < this.dicSize; i++){
			...
			this.gradOfFunctionOfBias2.add(gw2);
			...
			this.gradOfFunctionOfBias1.add(p2);
		}
	...
	public double gradInputCheck(double eps, int row, int col){
		...
		SimpleMatrix nextHidVec1 = this.weight1Para.mult(nextInputVec).plus(this.bias1Para);
		SimpleMatrix lastHidVec1 = this.weight1Para.mult(lastInputVec).plus(this.bias1Para);
		...
		SimpleMatrix nextHidVec2 = this.weight2Para.mult(nextHidVec1).plus(this.bias2Para);
		SimpleMatrix lastHidVec2 = this.weight2Para.mult(lastHidVec1).plus(this.bias2Para);
	...
	public double gradW1Check(double eps, int row, int col){
		...
		SimpleMatrix nextHidVec1 = nextWeight.mult(this.inputVec).plus(this.bias1Para);
		SimpleMatrix lastHidVec1 = lastWeight.mult(this.inputVec).plus(this.bias1Para);
	...
	public double gradBias1Check(double eps, int row, int col){
		SimpleMatrix newWeight = new SimpleMatrix(this.bias1Para.numRows(), this.bias1Para.numCols());
		newWeight.set(row, col, eps);
		SimpleMatrix nextBias = this.bias1Para.plus(newWeight);
		SimpleMatrix lastBias = this.bias1Para.minus(newWeight);
		
		SimpleMatrix nextHidVec1 = this.weight1Para.mult(this.inputVec).plus(nextBias);
		SimpleMatrix lastHidVec1 = this.weight1Para.mult(this.inputVec).plus(lastBias);
	...
	public double gradW2Check(double eps, int row, int col){
		...
		SimpleMatrix nextHidVec1 = this.weight1Para.mult(this.inputVec).plus(this.bias1Para);
		SimpleMatrix lastHidVec1 = this.weight1Para.mult(this.inputVec).plus(this.bias1Para);
		...
		SimpleMatrix nextHidVec2 = nextWeight.mult(nextHidVec1).plus(this.bias2Para);
		SimpleMatrix lastHidVec2 = lastWeight.mult(lastHidVec1).plus(this.bias2Para);
	...
	public double gradBias2Check(double eps, int row, int col){
		SimpleMatrix newWeight = new SimpleMatrix(this.bias2Para.numRows(), this.bias2Para.numCols());
		newWeight.set(row, col, eps);
		SimpleMatrix nextBias2 = this.bias2Para.plus(newWeight);
		SimpleMatrix lastBias2 = this.bias2Para.minus(newWeight);
		...
		SimpleMatrix nextHidVec2 = this.weight2Para.mult(nextHidVec1).plus(nextBias2);
		SimpleMatrix lastHidVec2 = this.weight2Para.mult(lastHidVec1).plus(lastBias2);
